  ...
  return (
    ...
    >
      <div className="container">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRF-Udq9mR0XWM0OT1pW0LZzrh6HD2TyueHEg&usqp=CAU"
          alt=""
        />
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0 gap-0 gap-lg-3">
            ...
            <li className="nav-item">
              <NavLink to="/course" className="nav-link " aria-current="page">
                Course
              </NavLink>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <NavLink to="/blogs" className="nav-link " aria-current="page">
                Blogs
              </NavLink>
            </li>
          </ul>
          {!user ? (
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 gap-3">
              <button onClick={changeMood} className="bg-none  border-0">
                <i class={mood ? "fa-solid fa-moon" : "fa-solid fa-sun"}></i>
              </button>
              <Link
                to="/sign-in"
                className="signInButton rounded-pill decorationNone"
              >
                Sign In
              </Link>
              <Link
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 gap-3">
              ...
              <button
                className="signOutButton rounded-pill decorationNone"
